...
| **F1-score** | **0.876** |
| Accuracy | 0.960 |
| Precision (отказ) | 0.88 |
| Recall (отказ) | 0.87 |

> Модель обучена на 16 504 примерах, протестирована на 4 127.  
> Дисбаланс классов 15% дефектов — целевая метрика ROC-AUC.  
> Early stopping сработал на итерации 115 из 1000 — переобучения нет.
